                            ...
                            <form action="{{ url('appointment') }}" method="POST">
                                ...
                                <div class="form-group" id="slots-container" style="display:none;">
                                    ...
                                    <div id="slots-unavailable" class="alert alert-warning" style="display:none;">
                                        ...
                                        Doctor is not available on this day. Please choose a different date.
                                    </div>

                                    <div id="slots-all-booked" class="alert alert-danger" style="display:none;">
                                        <i class="fas fa-times-circle"></i>
                                        All slots are fully booked for this day. Please choose a different date.
                                    </div>
...
<script>
    ...
    function loadSlots() {
        ...
        var allBooked = document.getElementById('slots-all-booked');
        ...
        fetch(slotsUrl + '?doctor_id=' + doctorId + '&date=' + date)
            ...
            .then(function(data) {
                ...
                var availableCount = data.slots.filter(function(s) {
                    return s.available;
                }).length;

                if (availableCount === 0) {
                    allBooked.style.display = 'block';
                    return;
                }
                ...
                data.slots.forEach(function(slot) {
                    ...
                    btn.className = 'btn btn-sm mr-1 mb-2 ' +
                        (slot.available ? 'btn-outline-primary' : 'btn-outline-secondary');
