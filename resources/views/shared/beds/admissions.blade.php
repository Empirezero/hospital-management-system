                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="text-info">{{ $admission->admitted_at->diffForHumans() }}</span>
                                        @else
                                        —
                                        @endif
                                    </td>
                                    ...
                                    <td>
                                        <a href="{{ route('beds.admission_detail', $admission->id) }}"
                                            class="btn btn-info btn-sm">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        @if($admission->status == 'admitted')
                                        <a href="{{ route('beds.discharge', $admission->id) }}"
                                ...
                                @empty
                                <tr>
                                    <td colspan="10" class="text-center text-muted py-4">No admissions yet.</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
