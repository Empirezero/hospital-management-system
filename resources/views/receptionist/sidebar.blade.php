    ...
    <ul class="navbar-nav navbar-right">
        <li class="dropdown notification-list">
            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg">
                ...
                <a href="{{ $notification->data['url'] ?? '#' }}" class="dropdown-item" onclick="markRead('{{ $notification->id }}')">
        ...
        <li class="dropdown">
            <a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                ...
                <img alt="avatar"
                    ...
                    style="height:35px; width:35px; object-fit:cover;">
                @endif
                <div class="d-sm-none d-lg-inline-block">Hi, {{ auth()->user()?->name ?? 'Receptionist' }}</div>
            </a>
...
<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ request()->is('receptionist/home') ? 'active' : '' }}">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="{{ route('receptionist.add_patient') }}">Register Patient</a></li>
                    <li><a class="nav-link" href="{{ route('receptionist.index') }}">View Patients</a></li>
                </ul>
            </li>
